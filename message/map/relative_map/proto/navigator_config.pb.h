...
#ifndef GOOGLE_PROTOBUF_INCLUDED_message_2fmap_2frelative_5fmap_2fproto_2fnavigator_5fconfig_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_message_2fmap_2frelative_5fmap_2fproto_2fnavigator_5fconfig_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_message_2fmap_2frelative_5fmap_2fproto_2fnavigator_5fconfig_2eproto
...
struct TableStruct_message_2fmap_2frelative_5fmap_2fproto_2fnavigator_5fconfig_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_message_2fmap_2frelative_5fmap_2fproto_2fnavigator_5fconfig_2eproto;
namespace civ {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::civ::relative_map::NavigatorConfig* Arena::CreateMaybeMessage<::civ::relative_map::NavigatorConfig>(Arena*);
template<> ::civ::relative_map::SampleParam* Arena::CreateMaybeMessage<::civ::relative_map::SampleParam>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace civ {
namespace relative_map {
...
class SampleParam PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:civ.relative_map.SampleParam) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "civ.relative_map.SampleParam";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_message_2fmap_2frelative_5fmap_2fproto_2fnavigator_5fconfig_2eproto);
    return ::descriptor_table_message_2fmap_2frelative_5fmap_2fproto_2fnavigator_5fconfig_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  double large_kappa_;
  friend struct ::TableStruct_message_2fmap_2frelative_5fmap_2fproto_2fnavigator_5fconfig_2eproto;
};
// -------------------------------------------------------------------

class NavigatorConfig PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:civ.relative_map.NavigatorConfig) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "civ.relative_map.NavigatorConfig";
  }
  protected:
  ...
  const ::civ::relative_map::SampleParam& sample_param() const;
  ::civ::relative_map::SampleParam* release_sample_param();
  ::civ::relative_map::SampleParam* mutable_sample_param();
  void set_allocated_sample_param(::civ::relative_map::SampleParam* sample_param);
  private:
  const ::civ::relative_map::SampleParam& _internal_sample_param() const;
  ::civ::relative_map::SampleParam* _internal_mutable_sample_param();
  public:
  void unsafe_arena_set_allocated_sample_param(
      ::civ::relative_map::SampleParam* sample_param);
  ::civ::relative_map::SampleParam* unsafe_arena_release_sample_param();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::civ::relative_map::SampleParam* sample_param_;
...
inline double SampleParam::straight_sample_interval() const {
  // @@protoc_insertion_point(field_get:civ.relative_map.SampleParam.straight_sample_interval)
...
inline void SampleParam::set_straight_sample_interval(double value) {
  ...
  // @@protoc_insertion_point(field_set:civ.relative_map.SampleParam.straight_sample_interval)
}
...
inline double SampleParam::small_kappa_sample_interval() const {
  // @@protoc_insertion_point(field_get:civ.relative_map.SampleParam.small_kappa_sample_interval)
...
inline void SampleParam::set_small_kappa_sample_interval(double value) {
  ...
  // @@protoc_insertion_point(field_set:civ.relative_map.SampleParam.small_kappa_sample_interval)
}
...
inline double SampleParam::middle_kappa_sample_interval() const {
  // @@protoc_insertion_point(field_get:civ.relative_map.SampleParam.middle_kappa_sample_interval)
...
inline void SampleParam::set_middle_kappa_sample_interval(double value) {
  ...
  // @@protoc_insertion_point(field_set:civ.relative_map.SampleParam.middle_kappa_sample_interval)
}
...
inline double SampleParam::large_kappa_sample_interval() const {
  // @@protoc_insertion_point(field_get:civ.relative_map.SampleParam.large_kappa_sample_interval)
...
inline void SampleParam::set_large_kappa_sample_interval(double value) {
  ...
  // @@protoc_insertion_point(field_set:civ.relative_map.SampleParam.large_kappa_sample_interval)
}
...
inline double SampleParam::small_kappa() const {
  // @@protoc_insertion_point(field_get:civ.relative_map.SampleParam.small_kappa)
...
inline void SampleParam::set_small_kappa(double value) {
  ...
  // @@protoc_insertion_point(field_set:civ.relative_map.SampleParam.small_kappa)
}
...
inline double SampleParam::middle_kappa() const {
  // @@protoc_insertion_point(field_get:civ.relative_map.SampleParam.middle_kappa)
...
inline void SampleParam::set_middle_kappa(double value) {
  ...
  // @@protoc_insertion_point(field_set:civ.relative_map.SampleParam.middle_kappa)
}
...
inline double SampleParam::large_kappa() const {
  // @@protoc_insertion_point(field_get:civ.relative_map.SampleParam.large_kappa)
...
inline void SampleParam::set_large_kappa(double value) {
  ...
  // @@protoc_insertion_point(field_set:civ.relative_map.SampleParam.large_kappa)
}
...
inline bool NavigatorConfig::enable_navigator_downsample() const {
  // @@protoc_insertion_point(field_get:civ.relative_map.NavigatorConfig.enable_navigator_downsample)
...
inline void NavigatorConfig::set_enable_navigator_downsample(bool value) {
  ...
  // @@protoc_insertion_point(field_set:civ.relative_map.NavigatorConfig.enable_navigator_downsample)
}
...
inline const ::civ::relative_map::SampleParam& NavigatorConfig::_internal_sample_param() const {
  const ::civ::relative_map::SampleParam* p = sample_param_;
  return p != nullptr ? *p : reinterpret_cast<const ::civ::relative_map::SampleParam&>(
      ::civ::relative_map::_SampleParam_default_instance_);
}
inline const ::civ::relative_map::SampleParam& NavigatorConfig::sample_param() const {
  // @@protoc_insertion_point(field_get:civ.relative_map.NavigatorConfig.sample_param)
...
inline void NavigatorConfig::unsafe_arena_set_allocated_sample_param(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:civ.relative_map.NavigatorConfig.sample_param)
}
inline ::civ::relative_map::SampleParam* NavigatorConfig::release_sample_param() {
  _has_bits_[0] &= ~0x00000001u;
  ::civ::relative_map::SampleParam* temp = sample_param_;
...
inline ::civ::relative_map::SampleParam* NavigatorConfig::unsafe_arena_release_sample_param() {
  // @@protoc_insertion_point(field_release:civ.relative_map.NavigatorConfig.sample_param)
  _has_bits_[0] &= ~0x00000001u;
  ::civ::relative_map::SampleParam* temp = sample_param_;
  sample_param_ = nullptr;
  return temp;
}
inline ::civ::relative_map::SampleParam* NavigatorConfig::_internal_mutable_sample_param() {
  _has_bits_[0] |= 0x00000001u;
  if (sample_param_ == nullptr) {
    auto* p = CreateMaybeMessage<::civ::relative_map::SampleParam>(GetArena());
    sample_param_ = p;
  }
  return sample_param_;
}
inline ::civ::relative_map::SampleParam* NavigatorConfig::mutable_sample_param() {
  // @@protoc_insertion_point(field_mutable:civ.relative_map.NavigatorConfig.sample_param)
  return _internal_mutable_sample_param();
}
inline void NavigatorConfig::set_allocated_sample_param(::civ::relative_map::SampleParam* sample_param) {
  ...
  sample_param_ = sample_param;
  // @@protoc_insertion_point(field_set_allocated:civ.relative_map.NavigatorConfig.sample_param)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_message_2fmap_2frelative_5fmap_2fproto_2fnavigator_5fconfig_2eproto
