...
#ifndef GOOGLE_PROTOBUF_INCLUDED_message_2fmap_2fproto_2fmap_5fjunction_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_message_2fmap_2fproto_2fmap_5fjunction_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_message_2fmap_2fproto_2fmap_5fjunction_2eproto
...
struct TableStruct_message_2fmap_2fproto_2fmap_5fjunction_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_message_2fmap_2fproto_2fmap_5fjunction_2eproto;
namespace civ {
namespace hdmap {
class Junction;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::civ::hdmap::Junction* Arena::CreateMaybeMessage<::civ::hdmap::Junction>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace civ {
namespace hdmap {
...
class Junction PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:civ.hdmap.Junction) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_message_2fmap_2fproto_2fmap_5fjunction_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  public:
  void clear_type();
  ::civ::hdmap::Junction_Type type() const;
  void set_type(::civ::hdmap::Junction_Type value);
  private:
  ::civ::hdmap::Junction_Type _internal_type() const;
  void _internal_set_type(::civ::hdmap::Junction_Type value);
  public:
 ...
 private:
  ...
  int type_;
  friend struct ::TableStruct_message_2fmap_2fproto_2fmap_5fjunction_2eproto;
};
// ===================================================================
...
inline const ::civ::hdmap::Id& Junction::_internal_id() const {
  const ::civ::hdmap::Id* p = id_;
  return p != nullptr ? *p : reinterpret_cast<const ::civ::hdmap::Id&>(
      ::civ::hdmap::_Id_default_instance_);
}
inline const ::civ::hdmap::Id& Junction::id() const {
  // @@protoc_insertion_point(field_get:civ.hdmap.Junction.id)
  return _internal_id();
}
inline void Junction::unsafe_arena_set_allocated_id(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:civ.hdmap.Junction.id)
}
inline ::civ::hdmap::Id* Junction::release_id() {
  _has_bits_[0] &= ~0x00000001u;
...
inline ::civ::hdmap::Id* Junction::unsafe_arena_release_id() {
  // @@protoc_insertion_point(field_release:civ.hdmap.Junction.id)
  _has_bits_[0] &= ~0x00000001u;
  ::civ::hdmap::Id* temp = id_;
  id_ = nullptr;
  return temp;
}
inline ::civ::hdmap::Id* Junction::_internal_mutable_id() {
  _has_bits_[0] |= 0x00000001u;
  if (id_ == nullptr) {
...
inline ::civ::hdmap::Id* Junction::mutable_id() {
  // @@protoc_insertion_point(field_mutable:civ.hdmap.Junction.id)
  return _internal_mutable_id();
}
inline void Junction::set_allocated_id(::civ::hdmap::Id* id) {
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:civ.hdmap.Junction.id)
}
...
inline const ::civ::hdmap::Polygon& Junction::_internal_polygon() const {
...
inline const ::civ::hdmap::Polygon& Junction::polygon() const {
  // @@protoc_insertion_point(field_get:civ.hdmap.Junction.polygon)
...
inline void Junction::unsafe_arena_set_allocated_polygon(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:civ.hdmap.Junction.polygon)
}
inline ::civ::hdmap::Polygon* Junction::release_polygon() {
  _has_bits_[0] &= ~0x00000002u;
...
inline ::civ::hdmap::Polygon* Junction::unsafe_arena_release_polygon() {
  // @@protoc_insertion_point(field_release:civ.hdmap.Junction.polygon)
  _has_bits_[0] &= ~0x00000002u;
  ::civ::hdmap::Polygon* temp = polygon_;
  polygon_ = nullptr;
  return temp;
}
inline ::civ::hdmap::Polygon* Junction::_internal_mutable_polygon() {
  _has_bits_[0] |= 0x00000002u;
  if (polygon_ == nullptr) {
...
inline ::civ::hdmap::Polygon* Junction::mutable_polygon() {
  // @@protoc_insertion_point(field_mutable:civ.hdmap.Junction.polygon)
  return _internal_mutable_polygon();
}
inline void Junction::set_allocated_polygon(::civ::hdmap::Polygon* polygon) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(polygon_);
  }
  ...
  polygon_ = polygon;
  // @@protoc_insertion_point(field_set_allocated:civ.hdmap.Junction.polygon)
}
...
inline ::civ::hdmap::Id* Junction::mutable_overlap_id(int index) {
  // @@protoc_insertion_point(field_mutable:civ.hdmap.Junction.overlap_id)
  return overlap_id_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::civ::hdmap::Id >*
Junction::mutable_overlap_id() {
  // @@protoc_insertion_point(field_mutable_list:civ.hdmap.Junction.overlap_id)
  return &overlap_id_;
}
inline const ::civ::hdmap::Id& Junction::_internal_overlap_id(int index) const {
  return overlap_id_.Get(index);
}
inline const ::civ::hdmap::Id& Junction::overlap_id(int index) const {
  // @@protoc_insertion_point(field_get:civ.hdmap.Junction.overlap_id)
  return _internal_overlap_id(index);
}
inline ::civ::hdmap::Id* Junction::_internal_add_overlap_id() {
  return overlap_id_.Add();
}
inline ::civ::hdmap::Id* Junction::add_overlap_id() {
  // @@protoc_insertion_point(field_add:civ.hdmap.Junction.overlap_id)
  return _internal_add_overlap_id();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::civ::hdmap::Id >&
Junction::overlap_id() const {
  // @@protoc_insertion_point(field_list:civ.hdmap.Junction.overlap_id)
  return overlap_id_;
}
...
inline ::civ::hdmap::Junction_Type Junction::_internal_type() const {
  return static_cast< ::civ::hdmap::Junction_Type >(type_);
}
inline ::civ::hdmap::Junction_Type Junction::type() const {
  // @@protoc_insertion_point(field_get:civ.hdmap.Junction.type)
  return _internal_type();
}
inline void Junction::_internal_set_type(::civ::hdmap::Junction_Type value) {
  assert(::civ::hdmap::Junction_Type_IsValid(value));
  _has_bits_[0] |= 0x00000004u;
  type_ = value;
}
inline void Junction::set_type(::civ::hdmap::Junction_Type value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:civ.hdmap.Junction.type)
}
...
template <> struct is_proto_enum< ::civ::hdmap::Junction_Type> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::civ::hdmap::Junction_Type>() {
  return ::civ::hdmap::Junction_Type_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_message_2fmap_2fproto_2fmap_5fjunction_2eproto
