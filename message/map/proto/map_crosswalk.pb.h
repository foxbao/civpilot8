...
#ifndef GOOGLE_PROTOBUF_INCLUDED_message_2fmap_2fproto_2fmap_5fcrosswalk_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_message_2fmap_2fproto_2fmap_5fcrosswalk_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_message_2fmap_2fproto_2fmap_5fcrosswalk_2eproto
...
struct TableStruct_message_2fmap_2fproto_2fmap_5fcrosswalk_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_message_2fmap_2fproto_2fmap_5fcrosswalk_2eproto;
namespace civ {
namespace hdmap {
class Crosswalk;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::civ::hdmap::Crosswalk* Arena::CreateMaybeMessage<::civ::hdmap::Crosswalk>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace civ {
namespace hdmap {
...
class Crosswalk PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:civ.hdmap.Crosswalk) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_message_2fmap_2fproto_2fmap_5fcrosswalk_2eproto);
    return ::descriptor_table_message_2fmap_2fproto_2fmap_5fcrosswalk_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_message_2fmap_2fproto_2fmap_5fcrosswalk_2eproto;
};
// ===================================================================
...
inline const ::civ::hdmap::Id& Crosswalk::_internal_id() const {
  const ::civ::hdmap::Id* p = id_;
  return p != nullptr ? *p : reinterpret_cast<const ::civ::hdmap::Id&>(
      ::civ::hdmap::_Id_default_instance_);
}
inline const ::civ::hdmap::Id& Crosswalk::id() const {
  // @@protoc_insertion_point(field_get:civ.hdmap.Crosswalk.id)
  return _internal_id();
}
inline void Crosswalk::unsafe_arena_set_allocated_id(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:civ.hdmap.Crosswalk.id)
}
inline ::civ::hdmap::Id* Crosswalk::release_id() {
  _has_bits_[0] &= ~0x00000001u;
...
inline ::civ::hdmap::Id* Crosswalk::unsafe_arena_release_id() {
  // @@protoc_insertion_point(field_release:civ.hdmap.Crosswalk.id)
  _has_bits_[0] &= ~0x00000001u;
  ::civ::hdmap::Id* temp = id_;
  id_ = nullptr;
  return temp;
}
inline ::civ::hdmap::Id* Crosswalk::_internal_mutable_id() {
  _has_bits_[0] |= 0x00000001u;
  if (id_ == nullptr) {
...
inline ::civ::hdmap::Id* Crosswalk::mutable_id() {
  // @@protoc_insertion_point(field_mutable:civ.hdmap.Crosswalk.id)
  return _internal_mutable_id();
}
inline void Crosswalk::set_allocated_id(::civ::hdmap::Id* id) {
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:civ.hdmap.Crosswalk.id)
}
...
inline const ::civ::hdmap::Polygon& Crosswalk::_internal_polygon() const {
...
inline const ::civ::hdmap::Polygon& Crosswalk::polygon() const {
  // @@protoc_insertion_point(field_get:civ.hdmap.Crosswalk.polygon)
...
inline void Crosswalk::unsafe_arena_set_allocated_polygon(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:civ.hdmap.Crosswalk.polygon)
}
inline ::civ::hdmap::Polygon* Crosswalk::release_polygon() {
  _has_bits_[0] &= ~0x00000002u;
...
inline ::civ::hdmap::Polygon* Crosswalk::unsafe_arena_release_polygon() {
  // @@protoc_insertion_point(field_release:civ.hdmap.Crosswalk.polygon)
  _has_bits_[0] &= ~0x00000002u;
  ::civ::hdmap::Polygon* temp = polygon_;
  polygon_ = nullptr;
  return temp;
}
inline ::civ::hdmap::Polygon* Crosswalk::_internal_mutable_polygon() {
  _has_bits_[0] |= 0x00000002u;
  if (polygon_ == nullptr) {
...
inline ::civ::hdmap::Polygon* Crosswalk::mutable_polygon() {
  // @@protoc_insertion_point(field_mutable:civ.hdmap.Crosswalk.polygon)
  return _internal_mutable_polygon();
}
inline void Crosswalk::set_allocated_polygon(::civ::hdmap::Polygon* polygon) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(polygon_);
  }
  ...
  polygon_ = polygon;
  // @@protoc_insertion_point(field_set_allocated:civ.hdmap.Crosswalk.polygon)
}
...
inline ::civ::hdmap::Id* Crosswalk::mutable_overlap_id(int index) {
  // @@protoc_insertion_point(field_mutable:civ.hdmap.Crosswalk.overlap_id)
  return overlap_id_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::civ::hdmap::Id >*
Crosswalk::mutable_overlap_id() {
  // @@protoc_insertion_point(field_mutable_list:civ.hdmap.Crosswalk.overlap_id)
  return &overlap_id_;
}
inline const ::civ::hdmap::Id& Crosswalk::_internal_overlap_id(int index) const {
  return overlap_id_.Get(index);
}
inline const ::civ::hdmap::Id& Crosswalk::overlap_id(int index) const {
  // @@protoc_insertion_point(field_get:civ.hdmap.Crosswalk.overlap_id)
  return _internal_overlap_id(index);
}
inline ::civ::hdmap::Id* Crosswalk::_internal_add_overlap_id() {
  return overlap_id_.Add();
}
inline ::civ::hdmap::Id* Crosswalk::add_overlap_id() {
  // @@protoc_insertion_point(field_add:civ.hdmap.Crosswalk.overlap_id)
...
Crosswalk::overlap_id() const {
  // @@protoc_insertion_point(field_list:civ.hdmap.Crosswalk.overlap_id)
  return overlap_id_;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_message_2fmap_2fproto_2fmap_5fcrosswalk_2eproto
