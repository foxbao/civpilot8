...
#ifndef GOOGLE_PROTOBUF_INCLUDED_message_2fmap_2fproto_2fmap_5fstop_5fsign_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_message_2fmap_2fproto_2fmap_5fstop_5fsign_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_message_2fmap_2fproto_2fmap_5fstop_5fsign_2eproto
...
struct TableStruct_message_2fmap_2fproto_2fmap_5fstop_5fsign_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_message_2fmap_2fproto_2fmap_5fstop_5fsign_2eproto;
namespace civ {
namespace hdmap {
class StopSign;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::civ::hdmap::StopSign* Arena::CreateMaybeMessage<::civ::hdmap::StopSign>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace civ {
namespace hdmap {
...
class StopSign PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:civ.hdmap.StopSign) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_message_2fmap_2fproto_2fmap_5fstop_5fsign_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  public:
  void clear_type();
  ::civ::hdmap::StopSign_StopType type() const;
  void set_type(::civ::hdmap::StopSign_StopType value);
  private:
  ::civ::hdmap::StopSign_StopType _internal_type() const;
  void _internal_set_type(::civ::hdmap::StopSign_StopType value);
  public:

  // @@protoc_insertion_point(class_scope:civ.hdmap.StopSign)
 private:
  class _Internal;
  ...
  ::civ::hdmap::Id* id_;
  int type_;
  friend struct ::TableStruct_message_2fmap_2fproto_2fmap_5fstop_5fsign_2eproto;
};
// ===================================================================
...
inline const ::civ::hdmap::Id& StopSign::_internal_id() const {
  const ::civ::hdmap::Id* p = id_;
  return p != nullptr ? *p : reinterpret_cast<const ::civ::hdmap::Id&>(
      ::civ::hdmap::_Id_default_instance_);
}
inline const ::civ::hdmap::Id& StopSign::id() const {
  // @@protoc_insertion_point(field_get:civ.hdmap.StopSign.id)
  return _internal_id();
}
inline void StopSign::unsafe_arena_set_allocated_id(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:civ.hdmap.StopSign.id)
}
inline ::civ::hdmap::Id* StopSign::release_id() {
  _has_bits_[0] &= ~0x00000001u;
...
inline ::civ::hdmap::Id* StopSign::unsafe_arena_release_id() {
  // @@protoc_insertion_point(field_release:civ.hdmap.StopSign.id)
  _has_bits_[0] &= ~0x00000001u;
  ::civ::hdmap::Id* temp = id_;
  id_ = nullptr;
  return temp;
}
inline ::civ::hdmap::Id* StopSign::_internal_mutable_id() {
  _has_bits_[0] |= 0x00000001u;
  if (id_ == nullptr) {
...
inline ::civ::hdmap::Id* StopSign::mutable_id() {
  // @@protoc_insertion_point(field_mutable:civ.hdmap.StopSign.id)
  return _internal_mutable_id();
}
inline void StopSign::set_allocated_id(::civ::hdmap::Id* id) {
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:civ.hdmap.StopSign.id)
}
...
inline ::civ::hdmap::Curve* StopSign::mutable_stop_line(int index) {
  // @@protoc_insertion_point(field_mutable:civ.hdmap.StopSign.stop_line)
  return stop_line_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::civ::hdmap::Curve >*
StopSign::mutable_stop_line() {
  // @@protoc_insertion_point(field_mutable_list:civ.hdmap.StopSign.stop_line)
  return &stop_line_;
}
inline const ::civ::hdmap::Curve& StopSign::_internal_stop_line(int index) const {
  return stop_line_.Get(index);
}
inline const ::civ::hdmap::Curve& StopSign::stop_line(int index) const {
  // @@protoc_insertion_point(field_get:civ.hdmap.StopSign.stop_line)
  return _internal_stop_line(index);
}
inline ::civ::hdmap::Curve* StopSign::_internal_add_stop_line() {
  return stop_line_.Add();
}
inline ::civ::hdmap::Curve* StopSign::add_stop_line() {
  // @@protoc_insertion_point(field_add:civ.hdmap.StopSign.stop_line)
...
StopSign::stop_line() const {
  // @@protoc_insertion_point(field_list:civ.hdmap.StopSign.stop_line)
  return stop_line_;
}
...
inline ::civ::hdmap::Id* StopSign::mutable_overlap_id(int index) {
  // @@protoc_insertion_point(field_mutable:civ.hdmap.StopSign.overlap_id)
  return overlap_id_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::civ::hdmap::Id >*
StopSign::mutable_overlap_id() {
  // @@protoc_insertion_point(field_mutable_list:civ.hdmap.StopSign.overlap_id)
  return &overlap_id_;
}
inline const ::civ::hdmap::Id& StopSign::_internal_overlap_id(int index) const {
  return overlap_id_.Get(index);
}
inline const ::civ::hdmap::Id& StopSign::overlap_id(int index) const {
  // @@protoc_insertion_point(field_get:civ.hdmap.StopSign.overlap_id)
  return _internal_overlap_id(index);
}
inline ::civ::hdmap::Id* StopSign::_internal_add_overlap_id() {
  return overlap_id_.Add();
}
inline ::civ::hdmap::Id* StopSign::add_overlap_id() {
  // @@protoc_insertion_point(field_add:civ.hdmap.StopSign.overlap_id)
  return _internal_add_overlap_id();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::civ::hdmap::Id >&
StopSign::overlap_id() const {
  // @@protoc_insertion_point(field_list:civ.hdmap.StopSign.overlap_id)
  return overlap_id_;
}
...
inline ::civ::hdmap::StopSign_StopType StopSign::_internal_type() const {
  return static_cast< ::civ::hdmap::StopSign_StopType >(type_);
}
inline ::civ::hdmap::StopSign_StopType StopSign::type() const {
  // @@protoc_insertion_point(field_get:civ.hdmap.StopSign.type)
  return _internal_type();
}
inline void StopSign::_internal_set_type(::civ::hdmap::StopSign_StopType value) {
  assert(::civ::hdmap::StopSign_StopType_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  type_ = value;
}
inline void StopSign::set_type(::civ::hdmap::StopSign_StopType value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:civ.hdmap.StopSign.type)
}
...
template <> struct is_proto_enum< ::civ::hdmap::StopSign_StopType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::civ::hdmap::StopSign_StopType>() {
  return ::civ::hdmap::StopSign_StopType_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_message_2fmap_2fproto_2fmap_5fstop_5fsign_2eproto
