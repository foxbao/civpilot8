...
_STOPSIGN_STOPTYPE = _descriptor.EnumDescriptor(
  name='StopType',
  full_name='civ.hdmap.StopSign.StopType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_STOPSIGN = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='civ.hdmap.StopSign.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='stop_line', full_name='civ.hdmap.StopSign.stop_line', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='overlap_id', full_name='civ.hdmap.StopSign.overlap_id', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='civ.hdmap.StopSign.type', index=3,
...
_STOPSIGN.fields_by_name['id'].message_type = message_dot_map_dot_proto_dot_map__id__pb2._ID
_STOPSIGN.fields_by_name['stop_line'].message_type = message_dot_map_dot_proto_dot_map__geometry__pb2._CURVE
_STOPSIGN.fields_by_name['overlap_id'].message_type = message_dot_map_dot_proto_dot_map__id__pb2._ID
...
StopSign = _reflection.GeneratedProtocolMessageType('StopSign', (_message.Message,), {
  ...
  '__module__' : 'message.map.proto.map_stop_sign_pb2'
