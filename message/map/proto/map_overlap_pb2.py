...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='message/map/proto/map_overlap.proto',
  package='civ.hdmap',
  syntax='proto2',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n#message/map/proto/map_overlap.proto\x12\tciv.hdmap\x1a\x1emessage/map/proto/map_id.proto\x1a$message/map/proto/map_geometry.proto\"m\n\x0fLaneOverlapInfo\x12\x0f\n\x07start_s\x18\x01 \x01(\x01\x12\r\n\x05\x65nd_s\x18\x02 \x01(\x01\x12\x10\n\x08is_merge\x18\x03 \x01(\x08\x12(\n\x11region_overlap_id\x18\x04 \x01(\x0b\x32\r.civ.hdmap.Id\"\x13\n\x11SignalOverlapInfo\"\x15\n\x13StopSignOverlapInfo\"@\n\x14\x43rosswalkOverlapInfo\x12(\n\x11region_overlap_id\x18\x01 \x01(\x0b\x32\r.civ.hdmap.Id\"\x15\n\x13JunctionOverlapInfo\"\x12\n\x10YieldOverlapInfo\"\x16\n\x14\x43learAreaOverlapInfo\"\x16\n\x14SpeedBumpOverlapInfo\"\x19\n\x17ParkingSpaceOverlapInfo\"\x18\n\x16PNCJunctionOverlapInfo\"\x10\n\x0eRSUOverlapInfo\"S\n\x11RegionOverlapInfo\x12\x19\n\x02id\x18\x01 \x01(\x0b\x32\r.civ.hdmap.Id\x12#\n\x07polygon\x18\x02 \x03(\x0b\x32\x12.civ.hdmap.Polygon\"\x8b\x06\n\x11ObjectOverlapInfo\x12\x19\n\x02id\x18\x01 \x01(\x0b\x32\r.civ.hdmap.Id\x12\x37\n\x11lane_overlap_info\x18\x03 \x01(\x0b\x32\x1a.civ.hdmap.LaneOverlapInfoH\x00\x12;\n\x13signal_overlap_info\x18\x04 \x01(\x0b\x32\x1c.civ.hdmap.SignalOverlapInfoH\x00\x12@\n\x16stop_sign_overlap_info\x18\x05 \x01(\x0b\x32\x1e.civ.hdmap.StopSignOverlapInfoH\x00\x12\x41\n\x16\x63rosswalk_overlap_info\x18\x06 \x01(\x0b\x32\x1f.civ.hdmap.CrosswalkOverlapInfoH\x00\x12?\n\x15junction_overlap_info\x18\x07 \x01(\x0b\x32\x1e.civ.hdmap.JunctionOverlapInfoH\x00\x12>\n\x17yield_sign_overlap_info\x18\x08 \x01(\x0b\x32\x1b.civ.hdmap.YieldOverlapInfoH\x00\x12\x42\n\x17\x63lear_area_overlap_info\x18\t \x01(\x0b\x32\x1f.civ.hdmap.ClearAreaOverlapInfoH\x00\x12\x42\n\x17speed_bump_overlap_info\x18\n \x01(\x0b\x32\x1f.civ.hdmap.SpeedBumpOverlapInfoH\x00\x12H\n\x1aparking_space_overlap_info\x18\x0b \x01(\x0b\x32\".civ.hdmap.ParkingSpaceOverlapInfoH\x00\x12\x46\n\x19pnc_junction_overlap_info\x18\x0c \x01(\x0b\x32!.civ.hdmap.PNCJunctionOverlapInfoH\x00\x12\x35\n\x10rsu_overlap_info\x18\r \x01(\x0b\x32\x19.civ.hdmap.RSUOverlapInfoH\x00\x42\x0e\n\x0coverlap_info\"\x88\x01\n\x07Overlap\x12\x19\n\x02id\x18\x01 \x01(\x0b\x32\r.civ.hdmap.Id\x12,\n\x06object\x18\x02 \x03(\x0b\x32\x1c.civ.hdmap.ObjectOverlapInfo\x12\x34\n\x0eregion_overlap\x18\x03 \x03(\x0b\x32\x1c.civ.hdmap.RegionOverlapInfo'
  ,
...
_LANEOVERLAPINFO = _descriptor.Descriptor(
  ...
  full_name='civ.hdmap.LaneOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='start_s', full_name='civ.hdmap.LaneOverlapInfo.start_s', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='end_s', full_name='civ.hdmap.LaneOverlapInfo.end_s', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='is_merge', full_name='civ.hdmap.LaneOverlapInfo.is_merge', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='region_overlap_id', full_name='civ.hdmap.LaneOverlapInfo.region_overlap_id', index=3,
...
_SIGNALOVERLAPINFO = _descriptor.Descriptor(
  ...
  full_name='civ.hdmap.SignalOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_STOPSIGNOVERLAPINFO = _descriptor.Descriptor(
  ...
  full_name='civ.hdmap.StopSignOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_CROSSWALKOVERLAPINFO = _descriptor.Descriptor(
  ...
  full_name='civ.hdmap.CrosswalkOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='region_overlap_id', full_name='civ.hdmap.CrosswalkOverlapInfo.region_overlap_id', index=0,
...
_JUNCTIONOVERLAPINFO = _descriptor.Descriptor(
  ...
  full_name='civ.hdmap.JunctionOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_YIELDOVERLAPINFO = _descriptor.Descriptor(
  ...
  full_name='civ.hdmap.YieldOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_CLEARAREAOVERLAPINFO = _descriptor.Descriptor(
  ...
  full_name='civ.hdmap.ClearAreaOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_SPEEDBUMPOVERLAPINFO = _descriptor.Descriptor(
  ...
  full_name='civ.hdmap.SpeedBumpOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_PARKINGSPACEOVERLAPINFO = _descriptor.Descriptor(
  ...
  full_name='civ.hdmap.ParkingSpaceOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_PNCJUNCTIONOVERLAPINFO = _descriptor.Descriptor(
  ...
  full_name='civ.hdmap.PNCJunctionOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_RSUOVERLAPINFO = _descriptor.Descriptor(
  name='RSUOverlapInfo',
  full_name='civ.hdmap.RSUOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_REGIONOVERLAPINFO = _descriptor.Descriptor(
  ...
  full_name='civ.hdmap.RegionOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='civ.hdmap.RegionOverlapInfo.id', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='polygon', full_name='civ.hdmap.RegionOverlapInfo.polygon', index=1,
...
_OBJECTOVERLAPINFO = _descriptor.Descriptor(
  ...
  full_name='civ.hdmap.ObjectOverlapInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='civ.hdmap.ObjectOverlapInfo.id', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='lane_overlap_info', full_name='civ.hdmap.ObjectOverlapInfo.lane_overlap_info', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='signal_overlap_info', full_name='civ.hdmap.ObjectOverlapInfo.signal_overlap_info', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='stop_sign_overlap_info', full_name='civ.hdmap.ObjectOverlapInfo.stop_sign_overlap_info', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='crosswalk_overlap_info', full_name='civ.hdmap.ObjectOverlapInfo.crosswalk_overlap_info', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='junction_overlap_info', full_name='civ.hdmap.ObjectOverlapInfo.junction_overlap_info', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='yield_sign_overlap_info', full_name='civ.hdmap.ObjectOverlapInfo.yield_sign_overlap_info', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='clear_area_overlap_info', full_name='civ.hdmap.ObjectOverlapInfo.clear_area_overlap_info', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='speed_bump_overlap_info', full_name='civ.hdmap.ObjectOverlapInfo.speed_bump_overlap_info', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='parking_space_overlap_info', full_name='civ.hdmap.ObjectOverlapInfo.parking_space_overlap_info', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pnc_junction_overlap_info', full_name='civ.hdmap.ObjectOverlapInfo.pnc_junction_overlap_info', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rsu_overlap_info', full_name='civ.hdmap.ObjectOverlapInfo.rsu_overlap_info', index=11,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='overlap_info', full_name='civ.hdmap.ObjectOverlapInfo.overlap_info',
...
_OVERLAP = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='civ.hdmap.Overlap.id', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='object', full_name='civ.hdmap.Overlap.object', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='region_overlap', full_name='civ.hdmap.Overlap.region_overlap', index=2,
...
_LANEOVERLAPINFO.fields_by_name['region_overlap_id'].message_type = message_dot_map_dot_proto_dot_map__id__pb2._ID
_CROSSWALKOVERLAPINFO.fields_by_name['region_overlap_id'].message_type = message_dot_map_dot_proto_dot_map__id__pb2._ID
_REGIONOVERLAPINFO.fields_by_name['id'].message_type = message_dot_map_dot_proto_dot_map__id__pb2._ID
_REGIONOVERLAPINFO.fields_by_name['polygon'].message_type = message_dot_map_dot_proto_dot_map__geometry__pb2._POLYGON
_OBJECTOVERLAPINFO.fields_by_name['id'].message_type = message_dot_map_dot_proto_dot_map__id__pb2._ID
...
_OVERLAP.fields_by_name['id'].message_type = message_dot_map_dot_proto_dot_map__id__pb2._ID
...
LaneOverlapInfo = _reflection.GeneratedProtocolMessageType('LaneOverlapInfo', (_message.Message,), {
  ...
  '__module__' : 'message.map.proto.map_overlap_pb2'
