...
// source: message/common/proto/header.proto
...
static void InitDefaultsscc_info_Header_message_2fcommon_2fproto_2fheader_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::civ::common::_Header_default_instance_;
    new (ptr) ::civ::common::Header();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Header_message_2fcommon_2fproto_2fheader_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Header_message_2fcommon_2fproto_2fheader_2eproto}, {
      &scc_info_StatusPb_message_2fcommon_2fproto_2ferror_5fcode_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_message_2fcommon_2fproto_2fheader_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_message_2fcommon_2fproto_2fheader_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_message_2fcommon_2fproto_2fheader_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_message_2fcommon_2fproto_2fheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::civ::common::Header, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::civ::common::Header, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::civ::common::Header, timestamp_sec_),
  PROTOBUF_FIELD_OFFSET(::civ::common::Header, module_name_),
  PROTOBUF_FIELD_OFFSET(::civ::common::Header, sequence_num_),
  PROTOBUF_FIELD_OFFSET(::civ::common::Header, lidar_timestamp_),
  PROTOBUF_FIELD_OFFSET(::civ::common::Header, camera_timestamp_),
  PROTOBUF_FIELD_OFFSET(::civ::common::Header, radar_timestamp_),
  PROTOBUF_FIELD_OFFSET(::civ::common::Header, version_),
  PROTOBUF_FIELD_OFFSET(::civ::common::Header, status_),
  PROTOBUF_FIELD_OFFSET(::civ::common::Header, frame_id_),
  3,
  0,
  7,
  4,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 14, sizeof(::civ::common::Header)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::civ::common::_Header_default_instance_),
};

const char descriptor_table_protodef_message_2fcommon_2fproto_2fheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n!message/common/proto/header.proto\022\nciv"
  ".common\032%message/common/proto/error_code"
  ".proto\"\342\001\n\006Header\022\025\n\rtimestamp_sec\030\001 \001(\001"
  "\022\023\n\013module_name\030\002 \001(\t\022\024\n\014sequence_num\030\003 "
  "\001(\r\022\027\n\017lidar_timestamp\030\004 \001(\004\022\030\n\020camera_t"
  "imestamp\030\005 \001(\004\022\027\n\017radar_timestamp\030\006 \001(\004\022"
  "\022\n\007version\030\007 \001(\r:\0011\022$\n\006status\030\010 \001(\0132\024.ci"
  "v.common.StatusPb\022\020\n\010frame_id\030\t \001(\t"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_message_2fcommon_2fproto_2fheader_2eproto_deps[1] = {
  &::descriptor_table_message_2fcommon_2fproto_2ferror_5fcode_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_message_2fcommon_2fproto_2fheader_2eproto_sccs[1] = {
  &scc_info_Header_message_2fcommon_2fproto_2fheader_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_message_2fcommon_2fproto_2fheader_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_message_2fcommon_2fproto_2fheader_2eproto = {
  false, false, descriptor_table_protodef_message_2fcommon_2fproto_2fheader_2eproto, "message/common/proto/header.proto", 315,
  &descriptor_table_message_2fcommon_2fproto_2fheader_2eproto_once, descriptor_table_message_2fcommon_2fproto_2fheader_2eproto_sccs, descriptor_table_message_2fcommon_2fproto_2fheader_2eproto_deps, 1, 1,
  schemas, file_default_instances, TableStruct_message_2fcommon_2fproto_2fheader_2eproto::offsets,
  file_level_metadata_message_2fcommon_2fproto_2fheader_2eproto, 1, file_level_enum_descriptors_message_2fcommon_2fproto_2fheader_2eproto, file_level_service_descriptors_message_2fcommon_2fproto_2fheader_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_message_2fcommon_2fproto_2fheader_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_message_2fcommon_2fproto_2fheader_2eproto)), true);
namespace civ {
namespace common {
...
class Header::_Internal {
 public:
  ...
  static const ::civ::common::StatusPb& status(const Header* msg);
...
Header::Header(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:civ.common.Header)
}
Header::Header(const Header& from)
  ...
  // @@protoc_insertion_point(copy_constructor:civ.common.Header)
}

void Header::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Header_message_2fcommon_2fproto_2fheader_2eproto.base);
  module_name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  frame_id_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
Header::~Header() {
  // @@protoc_insertion_point(destructor:civ.common.Header)
  SharedDtor();
...
void Header::Clear() {
// @@protoc_insertion_point(message_clear_start:civ.common.Header)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "civ.common.Header.module_name");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 7:
        ...
        continue;
      // optional .civ.common.StatusPb status = 8;
      case 8:
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 74)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "civ.common.Header.frame_id");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* Header::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:civ.common.Header)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:civ.common.Header)
  return target;
}

size_t Header::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:civ.common.Header)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:civ.common.Header)
  GOOGLE_DCHECK_NE(&from, this);
  const Header* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Header>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:civ.common.Header)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:civ.common.Header)
    MergeFrom(*source);
  }
}

void Header::MergeFrom(const Header& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:civ.common.Header)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:civ.common.Header)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:civ.common.Header)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::civ::common::Header* Arena::CreateMaybeMessage< ::civ::common::Header >(Arena* arena) {
  return Arena::CreateMessageInternal< ::civ::common::Header >(arena);
}
