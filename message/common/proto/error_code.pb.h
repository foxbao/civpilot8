...
#ifndef GOOGLE_PROTOBUF_INCLUDED_message_2fcommon_2fproto_2ferror_5fcode_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_message_2fcommon_2fproto_2ferror_5fcode_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_message_2fcommon_2fproto_2ferror_5fcode_2eproto
...
struct TableStruct_message_2fcommon_2fproto_2ferror_5fcode_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_message_2fcommon_2fproto_2ferror_5fcode_2eproto;
namespace civ {
namespace common {
class StatusPb;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::civ::common::StatusPb* Arena::CreateMaybeMessage<::civ::common::StatusPb>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace civ {
namespace common {
...
class StatusPb PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:civ.common.StatusPb) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_message_2fcommon_2fproto_2ferror_5fcode_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::civ::common::ErrorCode error_code() const;
  void set_error_code(::civ::common::ErrorCode value);
  private:
  ::civ::common::ErrorCode _internal_error_code() const;
  void _internal_set_error_code(::civ::common::ErrorCode value);
  public:

  // @@protoc_insertion_point(class_scope:civ.common.StatusPb)
 private:
  class _Internal;
  ...
  int error_code_;
  friend struct ::TableStruct_message_2fcommon_2fproto_2ferror_5fcode_2eproto;
};
// ===================================================================
...
inline ::civ::common::ErrorCode StatusPb::_internal_error_code() const {
  return static_cast< ::civ::common::ErrorCode >(error_code_);
}
inline ::civ::common::ErrorCode StatusPb::error_code() const {
  // @@protoc_insertion_point(field_get:civ.common.StatusPb.error_code)
  return _internal_error_code();
}
inline void StatusPb::_internal_set_error_code(::civ::common::ErrorCode value) {
  assert(::civ::common::ErrorCode_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  error_code_ = value;
}
inline void StatusPb::set_error_code(::civ::common::ErrorCode value) {
  _internal_set_error_code(value);
  // @@protoc_insertion_point(field_set:civ.common.StatusPb.error_code)
}
...
inline const std::string& StatusPb::msg() const {
  // @@protoc_insertion_point(field_get:civ.common.StatusPb.msg)
  return _internal_msg();
}
inline void StatusPb::set_msg(const std::string& value) {
  _internal_set_msg(value);
  // @@protoc_insertion_point(field_set:civ.common.StatusPb.msg)
}
inline std::string* StatusPb::mutable_msg() {
  // @@protoc_insertion_point(field_mutable:civ.common.StatusPb.msg)
...
inline void StatusPb::set_msg(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:civ.common.StatusPb.msg)
}
inline void StatusPb::set_msg(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:civ.common.StatusPb.msg)
}
inline void StatusPb::set_msg(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:civ.common.StatusPb.msg)
}
...
inline std::string* StatusPb::release_msg() {
  // @@protoc_insertion_point(field_release:civ.common.StatusPb.msg)
...
inline void StatusPb::set_allocated_msg(std::string* msg) {
  ...
  msg_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), msg,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:civ.common.StatusPb.msg)
}
...
template <> struct is_proto_enum< ::civ::common::ErrorCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::civ::common::ErrorCode>() {
  return ::civ::common::ErrorCode_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_message_2fcommon_2fproto_2ferror_5fcode_2eproto
