...
#ifndef GOOGLE_PROTOBUF_INCLUDED_message_2fcommon_2fproto_2fheader_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_message_2fcommon_2fproto_2fheader_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_message_2fcommon_2fproto_2fheader_2eproto
...
struct TableStruct_message_2fcommon_2fproto_2fheader_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_message_2fcommon_2fproto_2fheader_2eproto;
namespace civ {
namespace common {
class Header;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::civ::common::Header* Arena::CreateMaybeMessage<::civ::common::Header>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace civ {
namespace common {
...
class Header PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:civ.common.Header) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_message_2fcommon_2fproto_2fheader_2eproto);
    return ::descriptor_table_message_2fcommon_2fproto_2fheader_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  // @@protoc_insertion_point(class_scope:civ.common.Header)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_message_2fcommon_2fproto_2fheader_2eproto;
};
// ===================================================================
...
inline double Header::timestamp_sec() const {
  // @@protoc_insertion_point(field_get:civ.common.Header.timestamp_sec)
...
inline void Header::set_timestamp_sec(double value) {
  ...
  // @@protoc_insertion_point(field_set:civ.common.Header.timestamp_sec)
}
...
inline const std::string& Header::module_name() const {
  // @@protoc_insertion_point(field_get:civ.common.Header.module_name)
  return _internal_module_name();
}
inline void Header::set_module_name(const std::string& value) {
  _internal_set_module_name(value);
  // @@protoc_insertion_point(field_set:civ.common.Header.module_name)
}
inline std::string* Header::mutable_module_name() {
  // @@protoc_insertion_point(field_mutable:civ.common.Header.module_name)
...
inline void Header::set_module_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:civ.common.Header.module_name)
}
inline void Header::set_module_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:civ.common.Header.module_name)
}
inline void Header::set_module_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:civ.common.Header.module_name)
}
...
inline std::string* Header::release_module_name() {
  // @@protoc_insertion_point(field_release:civ.common.Header.module_name)
...
inline void Header::set_allocated_module_name(std::string* module_name) {
  ...
  module_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), module_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:civ.common.Header.module_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Header::sequence_num() const {
  // @@protoc_insertion_point(field_get:civ.common.Header.sequence_num)
...
inline void Header::set_sequence_num(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:civ.common.Header.sequence_num)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Header::lidar_timestamp() const {
  // @@protoc_insertion_point(field_get:civ.common.Header.lidar_timestamp)
...
inline void Header::set_lidar_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:civ.common.Header.lidar_timestamp)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Header::camera_timestamp() const {
  // @@protoc_insertion_point(field_get:civ.common.Header.camera_timestamp)
...
inline void Header::set_camera_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:civ.common.Header.camera_timestamp)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 Header::radar_timestamp() const {
  // @@protoc_insertion_point(field_get:civ.common.Header.radar_timestamp)
...
inline void Header::set_radar_timestamp(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:civ.common.Header.radar_timestamp)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Header::version() const {
  // @@protoc_insertion_point(field_get:civ.common.Header.version)
...
inline void Header::set_version(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:civ.common.Header.version)
}
...
inline const ::civ::common::StatusPb& Header::_internal_status() const {
...
inline const ::civ::common::StatusPb& Header::status() const {
  // @@protoc_insertion_point(field_get:civ.common.Header.status)
...
inline void Header::unsafe_arena_set_allocated_status(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:civ.common.Header.status)
}
inline ::civ::common::StatusPb* Header::release_status() {
  _has_bits_[0] &= ~0x00000004u;
...
inline ::civ::common::StatusPb* Header::unsafe_arena_release_status() {
  // @@protoc_insertion_point(field_release:civ.common.Header.status)
  _has_bits_[0] &= ~0x00000004u;
  ::civ::common::StatusPb* temp = status_;
  status_ = nullptr;
  return temp;
}
inline ::civ::common::StatusPb* Header::_internal_mutable_status() {
  _has_bits_[0] |= 0x00000004u;
  if (status_ == nullptr) {
...
inline ::civ::common::StatusPb* Header::mutable_status() {
  // @@protoc_insertion_point(field_mutable:civ.common.Header.status)
  return _internal_mutable_status();
}
inline void Header::set_allocated_status(::civ::common::StatusPb* status) {
  ...
  status_ = status;
  // @@protoc_insertion_point(field_set_allocated:civ.common.Header.status)
}
...
inline const std::string& Header::frame_id() const {
  // @@protoc_insertion_point(field_get:civ.common.Header.frame_id)
  return _internal_frame_id();
}
inline void Header::set_frame_id(const std::string& value) {
  _internal_set_frame_id(value);
  // @@protoc_insertion_point(field_set:civ.common.Header.frame_id)
}
inline std::string* Header::mutable_frame_id() {
  // @@protoc_insertion_point(field_mutable:civ.common.Header.frame_id)
...
inline void Header::set_frame_id(std::string&& value) {
  ...
  frame_id_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:civ.common.Header.frame_id)
}
inline void Header::set_frame_id(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:civ.common.Header.frame_id)
}
inline void Header::set_frame_id(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  frame_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:civ.common.Header.frame_id)
}
...
inline std::string* Header::release_frame_id() {
  // @@protoc_insertion_point(field_release:civ.common.Header.frame_id)
...
inline void Header::set_allocated_frame_id(std::string* frame_id) {
  ...
  frame_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), frame_id,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:civ.common.Header.frame_id)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_message_2fcommon_2fproto_2fheader_2eproto
