...
#include "message/common/proto/vehicle_state/vehicle_state.pb.h"
...
static void InitDefaultsscc_info_VehicleState_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::civ::common::_VehicleState_default_instance_;
    new (ptr) ::civ::common::VehicleState();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_VehicleState_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_VehicleState_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto}, {
      &scc_info_Pose_message_2flocalization_2fproto_2fpose_2eproto.base,}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, x_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, y_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, z_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, timestamp_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, roll_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, pitch_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, yaw_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, heading_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, kappa_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, linear_velocity_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, angular_velocity_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, linear_acceleration_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, pose_),
  PROTOBUF_FIELD_OFFSET(::civ::common::VehicleState, steering_percentage_),
  1,
  2,
  3,
  4,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 19, sizeof(::civ::common::VehicleState)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::civ::common::_VehicleState_default_instance_),
};

const char descriptor_table_protodef_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n6message/common/proto/vehicle_state/veh"
  "icle_state.proto\022\nciv.common\032%message/lo"
  "calization/proto/pose.proto\"\303\002\n\014VehicleS"
  ...
  "(\001:\0010\022\020\n\005pitch\030\006 \001(\001:\0010\022\016\n\003yaw\030\007 \001(\001:\0010\022"
  "\022\n\007heading\030\010 \001(\001:\0010\022\020\n\005kappa\030\t \001(\001:\0010\022\032\n"
  "\017linear_velocity\030\n \001(\001:\0010\022\033\n\020angular_vel"
  "ocity\030\013 \001(\001:\0010\022\036\n\023linear_acceleration\030\014 "
  "\001(\001:\0010\022$\n\004pose\030\017 \001(\0132\026.civ.localization."
  "Pose\022\033\n\023steering_percentage\030\020 \001(\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto_deps[1] = {
  &::descriptor_table_message_2flocalization_2fproto_2fpose_2eproto,
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto_sccs[1] = {
  &scc_info_VehicleState_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto = {
  false, false, descriptor_table_protodef_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto, "message/common/proto/vehicle_state/vehicle_state.proto", 433,
  &descriptor_table_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto_once, descriptor_table_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto_sccs, descriptor_table_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto_deps, 1, 1,
  schemas, file_default_instances, TableStruct_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto::offsets,
  file_level_metadata_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto, 1, file_level_enum_descriptors_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto, file_level_service_descriptors_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto)), true);
namespace civ {
namespace common {
...
class VehicleState::_Internal {
 public:
  ...
  static const ::civ::localization::Pose& pose(const VehicleState* msg);
...
VehicleState::VehicleState(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:civ.common.VehicleState)
}
VehicleState::VehicleState(const VehicleState& from)
  ...
  // @@protoc_insertion_point(copy_constructor:civ.common.VehicleState)
}

void VehicleState::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_VehicleState_message_2fcommon_2fproto_2fvehicle_5fstate_2fvehicle_5fstate_2eproto.base);
...
VehicleState::~VehicleState() {
  // @@protoc_insertion_point(destructor:civ.common.VehicleState)
  SharedDtor();
...
// @@protoc_insertion_point(message_clear_start:civ.common.VehicleState)
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 12:
        ...
        continue;
      // optional .civ.localization.Pose pose = 15;
      case 15:
...
::PROTOBUF_NAMESPACE_ID::uint8* VehicleState::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:civ.common.VehicleState)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:civ.common.VehicleState)
  return target;
}

size_t VehicleState::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:civ.common.VehicleState)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:civ.common.VehicleState)
  GOOGLE_DCHECK_NE(&from, this);
  const VehicleState* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<VehicleState>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:civ.common.VehicleState)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:civ.common.VehicleState)
    MergeFrom(*source);
  }
}

void VehicleState::MergeFrom(const VehicleState& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:civ.common.VehicleState)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:civ.common.VehicleState)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:civ.common.VehicleState)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::civ::common::VehicleState* Arena::CreateMaybeMessage< ::civ::common::VehicleState >(Arena* arena) {
  return Arena::CreateMessageInternal< ::civ::common::VehicleState >(arena);
}
