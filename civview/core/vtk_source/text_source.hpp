...
namespace civ {
namespace civview {
class TextSource : public SourceBase {
 public:
  TextSource();
 ...
 protected:
  ...
  void RefreshActorByOnlineImpl(vtkSmartPointer<vtkRenderer>& render);

 private:
    vtkSmartPointer<vtkTextActor> textActor_tobe_remove_ = nullptr;
