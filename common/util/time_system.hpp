...
template <typename _Dura = sc::microseconds>
// constexpr int64_t Epoch2Unix(const int y = 1970, const int m = 0, const int d
// = 0, const int hh = 0, const int mm = 0, const double ss = 0)
int64_t Epoch2Unix(const int y = 1970, const int m = 0, const int d = 0,
                   const int hh = 0, const int mm = 0, const double ss = 0) {
...
inline std::string FullTimeString(double t_s) {
  ...
  //   Unix2GPSTStr(t_s / 1e-6, true); return oss.str();
  std::string nonsense;
  return nonsense;
}
