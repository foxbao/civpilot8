...
DEFINE_string(map_dir, "/home/baojiali/Downloads/civpilot/map/data/demo",
...
DEFINE_string(vehicle_config_path,
              "/civ/modules/common/data/vehicle_param.pb.txt",
              "the file path of vehicle config file");

DEFINE_string(
    vehicle_model_config_filename,
    "/civ/modules/common/vehicle_model/conf/vehicle_model_config.pb.txt",
